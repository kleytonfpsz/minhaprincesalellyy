...
const namoroStartDate = new Date("2024-11-15T00:00:00");

// Função que atualiza o contador
function updateCounter() {
  const now = new Date();
  
  // Contador geral a partir de 13 de novembro
  ...
  if (elapsedTime < 0) {
    ...
    // Atualizar o HTML com o tempo decorrido desde 13 de novembro
  ...
  // Contador a partir de 13 de novembro
  ...
  if (namoroElapsedTime < 0) {
    ...
    document.getElementById("tempodenamoro").innerHTML = `
      <p>${namoroMonths} meses, ${namoroRemainingDays} dias, ${namoroRemainingHours} horas, ${namoroRemainingMinutes} minutos e ${namoroRemainingSeconds} segundos</p>
    `;
  }
}
